...
public class OSSClientUtil {
    ...
    // accessKey
    private String accessKeyId = "LTAIBoepZDy0gL8Y";
    private String accessKeySecret = "ukrGLEIzkTWtN2lfrcb833LDVa4ltH";
    // 空间
    private String bucketName = "langmoren";
    // 文件存储目录
    private String filedir = "langmoren/";
